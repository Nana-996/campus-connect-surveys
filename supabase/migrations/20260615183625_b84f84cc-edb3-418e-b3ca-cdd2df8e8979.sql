...
ALTER TABLE public.survey_response_starts
  DROP CONSTRAINT IF EXISTS survey_response_starts_started_at_not_backdated;
ALTER TABLE public.survey_response_starts
  ADD CONSTRAINT survey_response_starts_started_at_not_future
  CHECK (started_at <= now() + interval '5 seconds');
