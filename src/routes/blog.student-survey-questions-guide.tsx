...
const URL = "https://your-domain.com/blog/student-survey-questions-guide";
          ...
          mainEntity: [
            {
              ...
              acceptedAnswer: {
                "@type": "Answer",
                text: "Good student surveys mix short demographic questions (year, department, country) with 5–10 focused topic questions. Use rating scales (1–5) for opinions, single-choice for behavior frequency, and one or two open-text questions for context. Keep the whole survey under 3 minutes — completion rates collapse past that.",
              },
            },
            {
              "@type": "Question",
              ...
              acceptedAnswer: {
                "@type": "Answer",
                text: "Strongest-performing topics on CampusVerify are sleep & wellbeing, study habits, AI use in coursework, dating & social life, money & part-time work, campus food, mental health support, career plans, and political/social attitudes. These are the topics students actually want to share opinions on.",
              },
            },
            {
              "@type": "Question",
              ...
              acceptedAnswer: {
                "@type": "Answer",
                text: "Aim for 8–12 questions for the best response rate. Under 5 feels thin; over 15 causes drop-off. If you need more, split into two surveys.",
              },
            },
            {
              "@type": "Question",
              ...
              acceptedAnswer: {
                "@type": "Answer",
                text: 'Use a specific title ("Sleep & exam stress at UK unis" beats "Student survey"), keep it under 10 questions, target a clear group (year, country, interests), and offer a small incentive — on CampusVerify every answer earns the respondent credits, which is why response rates are 5–10× higher than cold links.',
              },
            },
          ],
        }),
...
const SECTIONS: Section[] = [
  {
    ...
    questions: [
      {
        text: "On average, how many hours per week do you study outside of class?",
        type: "choice",
        options: ["<5", "5–10", "10–20", "20–30", "30+"],
      },
      {
        text: "Where do you do most of your studying?",
        type: "choice",
      ...
      {
        text: "How often do you attend lectures in person?",
        type: "choice",
        options: ["Always", "Most of the time", "Sometimes", "Rarely", "Never"],
      },
      {
        text: "Which study method works best for you?",
        type: "choice",
        options: [
          "Re-reading notes",
          "Flashcards",
  ...
  },
  {
    ...
    questions: [
      ...
      {
        text: "Do you feel your university provides enough mental health support?",
        type: "rating",
      },
      {
        text: "Have you spoken to a counsellor or therapist in the last 12 months?",
        type: "choice",
        options: ["Yes", "No", "Prefer not to say"],
      },
      {
        text: "What's your biggest source of stress at university?",
        type: "choice",
        options: ["Exams/grades", "Money", "Relationships", "Future career", "Family", "Other"],
      },
      {
        text: "If you could change one thing about student mental health support on your campus, what would it be?",
        type: "text",
      },
    ],
  },
  {
    ...
    questions: [
      {
        text: "How often do you use AI tools (ChatGPT, Claude, Gemini) for coursework?",
        type: "choice",
        options: ["Daily", "Weekly", "Occasionally", "Rarely", "Never"],
      },
      {
        text: "What do you most use AI for?",
        type: "choice",
        options: [
          "Brainstorming",
          "Writing/editing",
      ...
      {
        text: "Does your university have a clear policy on AI use?",
        type: "choice",
      ...
      {
        text: "Has AI made you more or less confident in your writing?",
        type: "choice",
  ...
  },
  {
    ...
    questions: [
      ...
      {
        text: "How did you meet most of your close friends?",
        type: "choice",
        options: [
          "Halls/dorm",
          "Course/lectures",
      ...
      {
        text: "How often do you go out (clubs, bars, parties) in a typical week?",
        type: "choice",
        options: ["Never", "Once", "2–3×", "4+"],
      },
      {
        text: "Have you used a dating app in the last 6 months?",
        type: "choice",
        options: ["Yes", "No"],
      },
  ...
  },
  {
    ...
    questions: [
      {
        text: "Do you currently have a part-time job?",
        type: "choice",
  ...
  },
  {
    ...
    questions: [
      ...
      {
        text: "What's your top priority in a first job?",
        type: "choice",
        options: [
          "Salary",
          "Learning",
      ...
      {
        text: "Are you considering postgraduate study?",
        type: "choice",
        options: ["Yes — definitely", "Maybe", "No"],
      },
      { text: "How prepared do you feel for the job market?", type: "rating" },
      {
        text: "What kind of company do you most want to work for?",
        type: "choice",
        options: [
          "Startup",
          "Big tech",
  ...
  },
  {
    ...
    questions: [
      ...
      {
        text: "Where do you eat lunch most often?",
        type: "choice",
    ...
    <article className="mx-auto max-w-3xl px-6 py-12">
      ...
      <header className="mt-6">
        ...
        <p className="mt-4 max-w-2xl text-base text-muted-foreground">
          80+ proven questions across the topics university researchers, ed-tech founders, and
          student journalists ask most. Copy, adapt, and publish.
        </p>
      </header>
      ...
      <section className="prose prose-sm mt-10 max-w-none space-y-4 text-sm leading-relaxed">
        ...
        <p>
          The two biggest reasons student surveys flop are <strong>vague topics</strong> and{" "}
          <strong>too many questions</strong>. A survey called &ldquo;Student survey 2026&rdquo;
          with 25 questions will get a 3–5% completion rate. A survey called{" "}
          <em>&ldquo;Sleep &amp; exam stress at UK universities&rdquo;</em> with 8 questions will
          clear 40% — because the title tells the respondent who it&apos;s for and the length
          respects their time.
        </p>
        <p>
          The questions below are organised by topic, and each one is tagged with the question type
          (rating, single-choice, or open text) so you can drop it straight into your survey. Mix
          6–10 closed questions with one or two open-text questions and you&apos;ll get a survey
          that&apos;s short enough to finish and rich enough to analyse.
        </p>
      </section>
      ...
      <section className="mt-14 space-y-4 text-sm leading-relaxed">
        ...
        <ol className="list-decimal space-y-2 pl-5">
          <li>
            <strong>Be specific in the title.</strong> &ldquo;Sleep habits of 2nd-year engineering
            students&rdquo; outperforms &ldquo;Student survey&rdquo; by 5–10×.
          </li>
          <li>
            <strong>Keep it under 10 questions.</strong> Completion rate roughly halves between 10
            and 20 questions.
          </li>
          <li>
            <strong>Target the right group.</strong> Use country, year, and interest filters so the
            survey only appears to people who can answer it well.
          </li>
          <li>
            <strong>Offer a real incentive.</strong> On CampusVerify every answer earns the
            respondent credits they can spend on their own research — that&apos;s why response rates
            are dramatically higher than cold Google Forms links.
          </li>
        </ol>
      </section>
      ...
      <section className="mt-12 rounded-3xl border border-foreground/15 bg-card p-7 shadow-paper">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          Copy any of the questions above into CampusVerify and reach verified university students
          in minutes. Every respondent is .edu / .ac / .uni verified — no bots, no random Reddit
          traffic.
        </p>
      ...
      <section className="mt-12 space-y-4 text-sm leading-relaxed">
        ...
        <div>
          ...
          <p className="text-muted-foreground">
            Sleep &amp; wellbeing, study habits, AI use in coursework, dating &amp; social life,
            money &amp; part-time work, campus food, mental health, career plans, and political
            attitudes consistently get the most responses on CampusVerify.
          </p>
        </div>
        <div>
          <h3 className="font-semibold">Can I use these questions for academic research?</h3>
          <p className="text-muted-foreground">
            Yes — every question above is suitable for a dissertation, thesis, or class project.
            Always check your university&apos;s ethics guidelines before publishing surveys that
            touch on sensitive topics like mental health.
          </p>
        </div>
      </section>
    </article>
