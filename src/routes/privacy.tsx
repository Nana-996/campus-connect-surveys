    ...
    <div className="mx-auto max-w-3xl px-6 py-12">
      ...
      <div className="prose prose-sm mt-8 max-w-none space-y-6 text-sm leading-relaxed">
        ...
        <section>
          ...
          <p>To operate the platform, match surveys to relevant respondents, enforce the credit system, prevent abuse, and communicate service updates. We do not sell your personal data.</p>
        </section>
        <section>
        ...
        <section>
          ...
          <p>Row-level security policies restrict data access by user. Passwords are hashed by Supabase. We monitor for suspicious behavior and flag accounts that appear to abuse the credit system.</p>
        </section>
        <section>
          <h2 className="font-serif text-2xl">5. Your rights</h2>
          <p>You can update profile data inside the app, request export or deletion of your account by contacting support. Deletion removes your profile and active surveys; aggregated, anonymized analytics may be retained.</p>
        </section>
        <section>
          <h2 className="font-serif text-2xl">6. Cookies & local storage</h2>
          <p>We use local storage to keep you signed in and remember a few UI preferences. We do not use third-party advertising cookies.</p>
        </section>
        <section>
