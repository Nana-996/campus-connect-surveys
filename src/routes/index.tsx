  ...
  head: () => ({
    meta: [
      { title: "CampusVerify — Real research, real classmates, real fast" },
      {
        name: "description",
        content:
          "Run surveys with verified students from your campus or the wider public. Free to use — earn credits by answering surveys, spend them to publish your own.",
      },
      { property: "og:title", content: "CampusVerify — Surveys for verified students" },
      {
        property: "og:description",
        content:
          "A credit-powered survey feed for verified university students. Publish in seconds, get real answers from your campus.",
      },
    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          mainEntity: [
            {
              "@type": "Question",
              name: "Who can sign up?",
              acceptedAnswer: {
                "@type": "Answer",
                text: "Anyone with a valid academic email (.edu, .edu.xx, .ac.xx, .uni.xx) can create a student account. Non-students can sign up as general accounts and reach the wider public audience.",
              },
            },
            {
              "@type": "Question",
              ...
              acceptedAnswer: {
                "@type": "Answer",
                text: "You spend credits to publish a survey and earn 1 credit for each quality response you submit. CampusVerify is free to use — every credit you spend comes from answering other people's surveys.",
              },
            },
            {
              "@type": "Question",
              name: "Can I target specific departments?",
              acceptedAnswer: {
                "@type": "Answer",
                text: "Yes — pick the Targeted tier or higher to filter by department, year, country, age range, and interests.",
              },
            },
            {
              "@type": "Question",
              ...
              acceptedAnswer: {
                "@type": "Answer",
                text: "Survey creators see responses, not respondent identities beyond what your questions ask. See the Privacy Policy for the full picture.",
              },
            },
            {
              "@type": "Question",
              ...
              acceptedAnswer: {
                "@type": "Answer",
                text: "Use the Forgot password link on the login screen. We'll email a secure reset link.",
              },
            },
          ],
        }),
  ...
  return (
    <div className="min-h-screen">
      <header className="mx-auto flex max-w-6xl items-center justify-between px-6 py-6">
        <Link to="/" className="font-serif text-3xl text-primary">
          CampusVerify
        </Link>
        ...
        <div className="flex items-center gap-2">
            ...
            {isSignedIn ? (
              <Link to="/feed">
                <Button className="rounded-full bg-primary px-5">
                  Go to feed <ArrowUpRight className="ml-1 h-4 w-4" />
                </Button>
              </Link>
            ) : (
              <>
          ...
          <Sheet>
            ...
            <SheetContent side="right" className="w-3/4 sm:max-w-sm">
              <SheetHeader>
                <SheetTitle className="font-serif text-2xl text-primary text-left">
                  CampusVerify
                </SheetTitle>
              </SheetHeader>
              <nav className="mt-8 flex flex-col gap-4 text-sm font-semibold uppercase tracking-wider text-muted-foreground">
                <SheetClose asChild>
                  <a href="#how-it-works" className="py-2 hover:text-foreground">
                    How it works
                  </a>
                </SheetClose>
                <SheetClose asChild>
                  <Link to="/about" className="py-2 hover:text-foreground">
                    About
                  </Link>
                </SheetClose>
                <SheetClose asChild>
                  <a href="#faq" className="py-2 hover:text-foreground">
                    FAQ
                  </a>
                </SheetClose>
                ...
                {isSignedIn ? (
                  <SheetClose asChild>
                    <Link to="/feed" className="py-2 hover:text-foreground">
                      Go to feed
                    </Link>
                  </SheetClose>
                ) : (
                  <>
                    <SheetClose asChild>
                      <Link to="/auth" className="py-2 hover:text-foreground">
                        Log in
                      </Link>
                    </SheetClose>
                    <SheetClose asChild>
                      <Link to="/signup" className="py-2 text-primary hover:text-primary/80">
                        Get started
                      </Link>
                    </SheetClose>
                  </>
      ...
      <main className="mx-auto max-w-6xl px-6">
        ...
        <section className="grid gap-4 sm:grid-cols-6 sm:grid-rows-[auto_auto]">
          <div className="sm:col-span-4 sm:row-span-2 rounded-3xl border border-foreground/15 bg-card p-8 sm:p-12 shadow-paper">
            ...
            <h1 className="mt-5 font-serif text-5xl leading-[0.95] tracking-tight sm:text-7xl">
              Real research,
              <br />
              <em className="text-primary">real classmates,</em>
              <br />
              real fast.
            </h1>
            <p className="mt-6 max-w-xl text-base text-muted-foreground sm:text-lg">
              Run dissertations and side-projects on a feed of verified students from your own
              campus. No bots. No randoms. Just your people answering your questions.
            </p>
                ...
                <>
                  ...
                  <Link to="/auth">
                    <Button
                      size="lg"
                      variant="outline"
                      className="h-12 rounded-full border-foreground/30 px-7 text-base"
                    >
          ...
          <div className="sm:col-span-2 rounded-3xl bg-primary p-6 text-primary-foreground shadow-paper">
            ...
            <p className="mt-2 text-xs uppercase tracking-[0.2em] opacity-80">
              free credits for students on join
            </p>
        ...
        <section id="how-it-works" className="mt-20 scroll-mt-20">
          ...
          <h2 className="mt-2 font-serif text-4xl sm:text-5xl leading-[0.95]">
            Four steps. <em className="text-primary">No friction.</em>
          </h2>
          <div className="mt-8 grid gap-4 sm:grid-cols-4">
            <Step n="01" icon={<GraduationCap />} title="Verify">
              Sign up with your university email. Students get 10 free credits; general accounts get
              5.
            </Step>
            <Step n="02" icon={<Send />} title="Publish">
              Pick a tier (Basic, Targeted, Boosted, Pro), write questions, hit publish.
            </Step>
            <Step n="03" icon={<Inbox />} title="Earn">
              Answer surveys in your feed to earn credits — fund your own research at no cost.
            </Step>
            <Step n="04" icon={<Trophy />} title="Export">
              Watch responses land in real time. Export clean data when you're ready.
            </Step>
          </div>
        </section>
        ...
        <section
          id="about"
          className="mt-20 scroll-mt-20 rounded-3xl border border-foreground/15 bg-card p-8 sm:p-12 shadow-paper"
        >
          <div className="grid gap-8 sm:grid-cols-2">
            <div>
              ...
              <h2 className="mt-2 font-serif text-4xl sm:text-5xl leading-[0.95]">
                Built on campus, <em className="text-primary">for campus.</em>
              </h2>
              <p className="mt-4 text-sm text-muted-foreground leading-relaxed">
                CampusVerify started because thesis season shouldn't mean DMing strangers on
                WhatsApp. We give university researchers a clean, fair way to reach verified peers —
                and reward respondents for showing up with real answers.
              </p>
              <p className="mt-3 text-sm text-muted-foreground leading-relaxed">
                Every account is tied to a verified email. Every credit moves through a transparent
                ledger. No bots, no troll farms, no third-party advertisers staring over your
                shoulder.
              </p>
            </div>
        ...
        <section id="faq" className="mt-20 scroll-mt-20">
          ...
          <h2 className="mt-2 font-serif text-4xl sm:text-5xl leading-[0.95]">
            Quick <em className="text-primary">answers.</em>
          </h2>
          <div className="mt-8 grid gap-3 sm:grid-cols-2">
            <Faq q="Who can sign up?">
              Anyone with a valid academic email (.edu, .edu.xx, .ac.xx, .uni.xx) can create a
              student account. Non-students can sign up as general accounts and reach the wider
              public audience.
            </Faq>
            <Faq q="How do credits work?">
              You spend credits to publish a survey and earn 1 credit for each quality response you
              submit. CampusVerify is free to use — every credit you spend comes from answering
              other people's surveys.
            </Faq>
            <Faq q="Can I target specific departments?">
              Yes — pick the Targeted tier or higher to filter by department, year, country, age
              range, and interests.
            </Faq>
            <Faq q="How do I get more credits?">
              Open your feed and answer surveys from other people. Each quality response earns you 1
              credit — fuel for your own research.
            </Faq>
            <Faq q="Is my data private?">
              Survey creators see responses, not respondent identities beyond what your questions
              ask. See the{" "}
            ...
            <Faq q="What if I forgot my password?">
              ...
              link on the login screen. We'll email a secure reset link.
            </Faq>
          </div>
        </section>
        ...
        <section className="mt-20 rounded-3xl bg-primary p-10 text-center text-primary-foreground shadow-paper">
          ...
          <h2 className="mt-3 font-serif text-4xl sm:text-5xl leading-[0.95]">
            Ready to ask <em>better questions?</em>
          </h2>
        ...
        <div className="mx-auto grid max-w-6xl gap-8 px-6 py-12 sm:grid-cols-5">
          <div className="sm:col-span-2">
            ...
            <p className="mt-2 max-w-xs text-xs text-muted-foreground">
              A credit-powered survey feed for verified university students and the curious general
              public.
            </p>
          </div>
          <div>
  ...
  return (
    <details className="group rounded-2xl border border-foreground/15 bg-card p-5 shadow-paper">
      <summary className="cursor-pointer list-none font-serif text-lg flex items-center justify-between">
        {q}
        <span className="ml-2 text-xs text-muted-foreground transition group-open:rotate-45">
          ＋
        </span>
      </summary>
