...
export const Route = createFileRoute("/pitch")({
  ...
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "The verified student research network. A premium pitch deck for CampusVerify.",
      },
...
const Slide1 = () => (
  <SlideShell bg="green" align="center">
    ...
    >
      ...
      <span style={{ color: C.lime, fontStyle: "italic" }}>DMing strangers</span> on WhatsApp.
    </motion.h1>
    <motion.p
      variants={fadeUp}
      custom={2}
...
const Slide3 = () => (
  <SlideShell bg="green">
    ...
    <motion.h2
      ...
      style={{ fontFamily: SERIF, color: C.cream }}
    >
      A <span style={{ color: C.lime }}>credit-powered</span> survey network — verified, scoped, and
      free.
    </motion.h2>
      ...
      {[
        {
          ...
          summary:
            "Publish surveys to verified peers, answer surveys to earn credits, and export dissertation-ready reports.",
        },
        {
          icon: Users,
          ...
          summary:
            "Participate in public-audience surveys and lightweight campus polls — extending sample reach beyond a single university.",
        },
      ].map((c, i) => (
        <motion.div
          key={c.tag}
        ...
        >
          ...
          <p
            className="mt-6 border-t pt-5 text-base leading-relaxed"
            style={{ borderColor: C.line, color: C.cream, fontFamily: SERIF, fontStyle: "italic" }}
          >
            {c.summary}
          </p>
        </motion.div>
        ...
        {stages.map((s, i) => (
          ...
          >
            <motion.div
              ...
              style={{ background: C.lime }}
            />
            <div className="text-4xl font-light" style={{ fontFamily: SERIF, color: C.green }}>
              0{s.n}
            </div>
            <div
              className="mt-3 text-base font-semibold uppercase tracking-[0.14em]"
              style={{ color: C.green, fontFamily: SANS }}
            >
              {s.t}
            </div>
            <div className="mt-1 text-sm" style={{ color: C.mutedDark, fontFamily: SANS }}>
              {s.d}
            </div>
            {i < 3 && (
              <ArrowRight
      ...
      <div className="mt-8 grid w-full grid-cols-4 gap-4">
        {tiers.map((t, i) => (
          ...
          >
            ...
            <div className="mt-1 text-2xl font-semibold" style={{ fontFamily: SERIF }}>
              {t.name}
            </div>
            <div className="mt-1 text-sm" style={{ color: C.muted, fontFamily: SANS }}>
              {t.desc}
            </div>
          </motion.div>
        ))}
    ...
    <div className="mt-10 grid w-full grid-cols-2 gap-10">
      ...
      <motion.div variants={fadeUp} custom={2} className="relative">
        ...
        >
          ...
          <div className="mt-3 flex flex-wrap gap-2">
            {["Pharmacy", "Year 3–4", "12 questions"].map((t) => (
              <span
                ...
                style={{ borderColor: C.lineDark, color: C.green }}
              >
                {t}
              </span>
            ))}
          ...
          <div
            className="mt-5 flex items-center justify-center gap-2 text-[10px] uppercase tracking-[0.28em]"
            style={{ color: C.mutedDark }}
          >
            ← swipe →
          </div>
        ...
        {[
          {
            icon: Filter,
            t: "Matched to you",
            d: "By department, year, and interests — you only see what's relevant.",
          },
          {
            icon: Building2,
            t: "Campus-scoped",
            d: "Surveys stay inside your university unless the creator opts in to a public audience.",
          },
          {
            icon: Coins,
            t: "Earn instantly",
            d: "Answering earns 1 credit, credited to your account in real time.",
          },
        ].map((b, i) => (
          <motion.div
            key={b.t}
            variants={fadeUp}
            custom={3 + i}
            className="flex items-start gap-4 py-5 border-b last:border-0"
            style={{ borderColor: C.line }}
          >
            <b.icon className="mt-1 h-6 w-6 shrink-0" style={{ color: C.lime }} />
            <div>
              <div className="text-lg font-semibold" style={{ color: C.cream, fontFamily: SANS }}>
                {b.t}
              </div>
              <div className="mt-1 text-base" style={{ color: C.muted, fontFamily: SANS }}>
                {b.d}
              </div>
            </div>
          </motion.div>
  ...
  const steps = [
    {
      ...
      icon: PenLine,
      t: "Write",
      d: "Closed-ended (multiple choice, rating scales) or open-ended (free text).",
    },
  ...
  return (
    <SlideShell bg="cream">
      ...
      >
        ...
        <div>
          <div className="text-xs font-bold uppercase tracking-[0.24em]" style={{ color: C.lime }}>
            The differentiator
          </div>
          <p className="mt-2 text-2xl leading-snug" style={{ fontFamily: SERIF }}>
            Targeted tier is the core differentiator — a Psychology Year 3 student's survey only
            reaches Psychology Year 3 students.{" "}
  ...
  return (
    <SlideShell bg="green">
        ...
        {[
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <h3 className="text-2xl" style={{ fontFamily: SERIF, color: C.cream }}>
                {panel.title}
              </h3>
            </div>
      ...
      <motion.p
        ...
        style={{ color: C.lime, fontFamily: SERIF }}
      >
        The only survey platform that takes you from "survey published" to "PDF submitted" without
        leaving the app.
      </motion.p>
    </SlideShell>
  );
      ...
      <div className="mt-10 grid w-full grid-cols-2 gap-x-10 gap-y-4">
        {items.map((it, i) => (
          ...
          >
            ...
            <p className="text-[15px] leading-relaxed" style={{ color: C.green, fontFamily: SANS }}>
              {it}
            </p>
          </motion.div>
        ))}
      ...
      >
        <div className="flex items-center gap-3">
          ...
          <p className="text-lg" style={{ fontFamily: SERIF, fontStyle: "italic" }}>
            100% verified accounts. 0 third-party ad trackers. Built to meet GDPR-adjacent standards
            from day one.
          </p>
        </div>
      </motion.div>
  ...
  const items = [
    {
      icon: Smartphone,
      t: "Offline-first PWA",
      d: "Installs to the home screen like a native app — no app store needed.",
    },
    {
      icon: WifiOff,
      t: "Answer offline",
      d: "Responses are saved locally when there's no connection and sync automatically when reconnected.",
    },
    {
      icon: Database,
      t: "Service-worker caching",
      d: "Core UI loads even with zero connectivity — students never lose progress mid-survey.",
    },
  ];
  return (
    <SlideShell bg="green">
      ...
      <div className="mt-12 grid w-full grid-cols-3 gap-6">
        {items.map((it, i) => (
          ...
          >
            ...
            <h3 className="mt-5 text-2xl" style={{ fontFamily: SERIF, color: C.cream }}>
              {it.t}
            </h3>
            <p
              className="mt-2 text-base leading-relaxed"
  ...
  const users = [
    {
      ...
      story:
        "A final-year Pharmacy student at a Ghanaian university needs 80 verified responses for their dissertation on drug adherence among peers. They publish a Targeted survey scoped to Health Sciences, Years 3–4. 80 responses in 48 hours. PDF report exported. Supervisor approves.",
    },
    {
      icon: Smartphone,
      tag: "The respondent",
      ...
      story:
        "A Business Year 2 student answers 10 surveys over a month — earns 10 credits — and uses them to publish their own mini-survey for a class project. Zero cash spent.",
    },
    {
      icon: Building2,
      tag: "The institution",
      ...
      story:
        "Faculty managers access the /manage panel to track survey activity, view completion rates by department, and ensure research integrity across the student body. Index numbers allow audit trails.",
    },
  ];
  return (
    <SlideShell bg="cream">
      ...
      <div className="mt-10 grid w-full grid-cols-3 gap-5">
        {users.map((u, i) => (
          ...
          >
            ...
            <h3 className="mt-1 text-2xl" style={{ fontFamily: SERIF, color: C.green }}>
              {u.role}
            </h3>
            <p
  ...
  return (
    <SlideShell bg="cream">
      ...
      <motion.h2
        ...
        style={{ fontFamily: SERIF, color: C.green }}
      >
        Lecturers see <em style={{ color: C.limeDeep }}>exactly</em> who has — and hasn't —
        responded.
      </motion.h2>
      <p className="mt-4 max-w-3xl text-lg" style={{ color: C.mutedDark, fontFamily: SANS }}>
        University-scoped tracking by department, year, and index number. Answer content stays
        confidential — only participation is visible. Chase the gaps, not every student.
      </p>
      ...
      <div className="mt-8 grid w-full grid-cols-5 gap-6">
        ...
        <motion.div
          variants={fadeUp}
          custom={2}
          className="col-span-3 overflow-hidden rounded-2xl border"
          style={{ borderColor: C.lineDark, background: "rgba(255,255,255,0.6)" }}
        >
          <div
            className="flex items-center justify-between px-5 py-3 text-xs font-bold uppercase tracking-[0.22em]"
            style={{ background: C.green, color: C.lime, fontFamily: SANS }}
          >
                ...
                >
                  ...
                  <td className="px-4 py-2">
                    ...
                    >
                      ...
                      {r.status}{" "}
                      {r.status === "Responded" && <span className="opacity-60">· {r.when}</span>}
                    </span>
                  </td>
                </tr>
              ))}
        ...
        <motion.div variants={fadeUp} custom={3} className="col-span-2 flex flex-col gap-4">
          {[
            {
              icon: UserCheck,
              t: "Live participation map",
              d: "Filter by department, year, or index — instantly see who is missing.",
            },
            {
              icon: Bell,
              t: "Targeted follow-up",
              d: "Contact only the non-respondents. No more group-blast spam.",
            },
            {
              icon: ShieldCheck,
              t: "Answers stay private",
              d: "Supervisors see participation, never individual responses.",
            },
          ].map((b, i) => (
            <div
              key={b.t}
            ...
            >
              ...
              <div>
                ...
                <div className="text-[13px]" style={{ color: C.mutedDark, fontFamily: SANS }}>
                  {b.d}
                </div>
              </div>
            </div>
...
const SlideAdmin = () => {
  const tools = [
    {
      icon: Coins,
      t: "Grant bonus credits",
      d: "Reward power users, run campus campaigns, or top-up researchers running large studies — all from one panel.",
    },
    {
      icon: ShieldCheck,
      t: "Flag & moderate users",
      d: "Lock suspicious accounts, surface low-quality respondents, resolve review flags from the community.",
    },
    {
      icon: Settings,
      t: "Role management",
      d: "Promote faculty as managers, grant admins by email, revoke access with one click.",
    },
    {
      icon: Filter,
      t: "Domain blocklist",
      d: "Auto-reject disposable email domains so only real .edu / .ac inboxes get verified.",
    },
    {
      icon: FileBarChart,
      t: "Live platform metrics",
      d: "Users, active surveys, 24h responses, open flags — a real-time pulse of the network.",
    },
    {
      icon: Database,
      t: "Survey takedown",
      d: "One-click deactivate or delete any survey violating policy. Audit-logged.",
    },
  ];
  return (
    <SlideShell bg="green">
      ...
      <motion.h2
        ...
        style={{ fontFamily: SERIF, color: C.cream }}
      >
        A purpose-built <span style={{ color: C.lime, fontStyle: "italic" }}>admin console</span> —
        not a database editor.
      </motion.h2>
      <p className="mt-4 max-w-3xl text-lg" style={{ color: C.muted, fontFamily: SANS }}>
        Every operational lever the platform owner needs lives in{" "}
        <code style={{ color: C.lime }}>/admin</code>. Secured by row-level policies + a
        security-definer <code style={{ color: C.lime }}>has_role()</code> check on every action.
      </p>
      <div className="mt-10 grid w-full grid-cols-3 gap-5">
        {tools.map((t, i) => (
          <motion.div
          ...
          >
            ...
            <h3 className="mt-4 text-xl" style={{ fontFamily: SERIF, color: C.cream }}>
              {t.t}
            </h3>
            <p
...
const SlideLecturer = () => (
  <SlideShell bg="cream">
    ...
    <p className="mt-4 max-w-3xl text-lg" style={{ color: C.mutedDark, fontFamily: SANS }}>
      A first-class lecturers directory plus a pre-loaded evaluation template means
      quality-assurance offices can launch a faculty-wide review in minutes — not weeks.
    </p>
        ...
        <ul className="mt-5 space-y-3 text-[15px]" style={{ color: C.green, fontFamily: SANS }}>
          {[
            ...
            <li key={x} className="flex gap-2">
              <span style={{ color: C.limeDeep }}>›</span>
              {x}
            </li>
          ))}
        </ul>
        ...
        <div className="mt-6 flex gap-2">
          {[1, 2, 3, 4, 5].map((n) => (
            <div
              ...
              style={{ borderColor: C.lime, color: C.lime, fontFamily: SANS, fontWeight: 600 }}
            >
              {n}
            </div>
          ))}
...
const SlideQuality = () => {
  const items = [
    {
      icon: Award,
      t: "Quality score per response",
      d: "Auto-computed from completion time, straight-lining, open-text length. Low-quality responses can be excluded from analysis.",
    },
    {
      icon: ShieldCheck,
      t: "Anonymous by default",
      d: "Respondents opt in to share identity. Identified respondents are visible to faculty trackers but never to peers.",
    },
    {
      icon: Link2,
      t: "Shareable referral links",
      d: "Each survey gets a private link with a token. Off-platform recipients verify before answering — no spoofing.",
    },
    {
      icon: Trophy,
      t: "Earned vs purchased credits",
      d: "Two-wallet ledger keeps the economy honest. Expiry on bonus grants prevents hoarding.",
    },
  ];
  return (
    <SlideShell bg="green">
      ...
      <div className="mt-10 grid w-full grid-cols-2 gap-6">
        {items.map((it, i) => (
          ...
          >
            ...
            <div>
              <h3 className="text-xl" style={{ fontFamily: SERIF, color: C.cream }}>
                {it.t}
              </h3>
              <p
...
const SlideAdvantage = () => {
  ...
  const cell = (v: any) =>
    v === true ? (
      ...
      <span className="text-2xl" style={{ color: C.green, opacity: 0.2 }}>
        —
      </span>
    ) : (
      <span className="text-xs" style={{ color: C.mutedDark, fontFamily: SANS }}>
        {v}
      </span>
    );
  return (
    <SlideShell bg="cream">
      ...
      <motion.div
        variants={fadeUp}
        custom={2}
        className="mt-10 w-full overflow-hidden rounded-2xl border"
        ...
        <table className="w-full text-[15px]" style={{ fontFamily: SANS }}>
          <thead style={{ background: C.green, color: C.cream }}>
            <tr>
              ...
              <th
                className="px-6 py-4 text-center text-xs font-bold uppercase tracking-[0.2em]"
                style={{ color: C.lime }}
              >
                CampusVerify
              </th>
              <th className="px-6 py-4 text-center text-xs font-bold uppercase tracking-[0.2em]">
                SurveyMonkey
              </th>
              <th className="px-6 py-4 text-center text-xs font-bold uppercase tracking-[0.2em]">
                Google Forms
            ...
            {rows.map((r) => (
              ...
              >
                ...
                <td
                  ...
                  style={{ background: "rgba(184,224,74,0.12)" }}
                >
                  {cell(r.cv)}
                </td>
...
const Slide11 = () => {
  const roadmap = [
    ...
    {
      when: "2027",
      what: "Pan-African network — lecturer evaluations, peer polls, institutional API",
    },
    {
      when: "2028",
      what: "Open research platform — white-label for university research departments",
    },
  ];
  const ctas = [
  ...
  return (
    <SlideShell bg="green">
      ...
      <motion.h2
        ...
        style={{ fontFamily: SERIF, color: C.cream }}
      >
        From <span style={{ color: C.lime, fontStyle: "italic" }}>one campus</span> to{" "}
        <span style={{ color: C.lime, fontStyle: "italic" }}>every campus</span>.
      </motion.h2>
      ...
      <div className="relative mt-10 grid w-full grid-cols-4 gap-4">
        <div
          ...
          style={{ background: C.lime, opacity: 0.3 }}
        />
        {roadmap.map((r, i) => (
      ...
      <div className="mt-10 grid w-full grid-cols-3 gap-5">
        {ctas.map((c, i) => (
          <motion.div
            ...
            style={{
              background: i === 2 ? C.lime : "rgba(245,240,232,0.06)",
              color: i === 2 ? C.green : C.cream,
              border: `1px solid ${i === 2 ? "transparent" : C.line}`,
            }}
          >
            <c.icon className="h-7 w-7 shrink-0" style={{ color: i === 2 ? C.green : C.lime }} />
            <div>
              <div className="text-xl font-semibold" style={{ fontFamily: SANS }}>
                {c.t}
              </div>
              <div
                className="mt-1 text-sm"
                style={{ fontFamily: SANS, opacity: i === 2 ? 0.85 : 0.7 }}
              >
                {c.d}
              </div>
            </div>
      ...
      <motion.div
        variants={fadeUp}
        custom={10}
        className="mt-auto flex w-full items-center justify-between pt-10"
      >
        <Wordmark />
        <span
          className="text-sm uppercase tracking-[0.3em] italic"
          style={{ color: C.muted, fontFamily: SERIF }}
        >
